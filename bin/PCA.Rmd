...
##This script make a PCA analysis with the R package SNPRelate. The data is from the work of Schweizer et al. 2015 used in the bash scripts "Download_data" and "use_vcftools" in this directory.

###Install packages SNPRelate, ape and ggplot2 if is necessary. If we already have this packages, only load the libraries in the next step 
```{r}
